...
urlpatterns = [
    ...
    path('insumos/inactivos/', views.listar_insumos_inactivos, name='listar_insumos_inactivos'), 
    ...
    path('productos/<int:producto_id>/ingredientes/', views.gestionar_ingredientes, name='gestionar_ingredientes'),
]